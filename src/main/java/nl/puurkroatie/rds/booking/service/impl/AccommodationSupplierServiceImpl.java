...
public class AccommodationSupplierServiceImpl implements AccommodationSupplierService {
    ...
    public AccommodationSupplierServiceImpl(AccommodationSupplierRepository accommodationSupplierRepository, AccommodationRepository accommodationRepository, SupplierRepository supplierRepository) {
    ...
    private AccommodationSupplierDto toDto(AccommodationSupplier entity) {
        return new AccommodationSupplierDto(
