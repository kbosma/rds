...
@RestController
@RequestMapping("/api/booker-portal/activities")
public class BookerPortalActivitiesController {

    private final BookingActivityRepository bookingActivityRepository;

    public BookerPortalActivitiesController(BookingActivityRepository bookingActivityRepository) {
