...
class AccommodationSupplierControllerTest extends AbstractBookingControllerTest {
    ...
    // ADMIN: GET /api/accommodation-suppliers — geen ACCOMMODATION_READ authority → 403
    @Test
    ...
    // ADMIN: GET /api/accommodation-suppliers/{accommodationId}/{supplierId} — geen ACCOMMODATION_READ authority → 403
    @Test
    ...
    // EMPLOYEE: POST /api/accommodation-suppliers — geen ACCOMMODATION_CREATE authority → 403
    @Test
    void employee_createAccommodationSupplier_returns403() throws Exception {
        String token = employeeToken();
    ...
    // EMPLOYEE: DELETE /api/accommodation-suppliers/{accId}/{supId} — geen ACCOMMODATION_DELETE authority → 403
    @Test
    void employee_deleteAccommodationSupplier_returns403() throws Exception {
        String token = employeeToken();
